# 🏫 Crescent Public School & College
## School Website + School Management System

**স্কুলের নাম:** Crescent Public School & College (ক্রেসেন্ট পাবলিক স্কুল অ্যান্ড কলেজ)  
**EIIN:** 108877 | **প্রতিষ্ঠা:** 2001  
**ঠিকানা:** Plot 7, Block C, Mirpur-10, Dhaka-1216  
...
ডেটা ব্রাউজারের **LocalStorage** এ সংরক্ষিত হয়। এর মানে:

- ✅ ইন্টারনেট ছাড়াই কাজ করে, কোনো খরচ নেই
- ⚠️ ডেটা **প্রতিটি ব্রাউজার/ডিভাইসে আলাদা** — অন্য কম্পিউটার থেকে দেখা যাবে না
- ⚠️ ব্রাউজারের ডেটা ক্লিয়ার করলে মুছে যাবে

**নিয়মিত ব্যাকআপ নিন:** Admin → **Settings → Backup / Restore → Download Backup (JSON)**
অন্য ডিভাইসে সেই JSON ফাইল Restore করলেই সব ডেটা চলে আসবে।

### একাধিক ডিভাইসে শেয়ার করতে চাইলে
`BACKEND.md` ফাইলে **Supabase** ও **Firebase** সংযোগের সম্পূর্ণ গাইড আছে —
SQL schema, Row Level Security policies, Firestore rules ও নিরাপদ result-search RPC সহ।
তখন সব ডিভাইস থেকে একই ডেটা দেখা যাবে।
